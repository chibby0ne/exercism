...
#[test]
#[ignore]
fn degenerate_sum_of_two_sides_equals_the_remaining_side_one() {
    let sides = [1, 1, 2];
    let triangle = Triangle::build(sides).unwrap();
...
#[test]
#[ignore]
fn degenerate_sum_of_two_sides_equals_the_remaining_side_two() {
    let sides = [1, 2, 3];
    let triangle = Triangle::build(sides).unwrap();
    assert!(triangle.is_degenerate());
}
...
#[test]
#[ignore]
fn degenerate_sum_of_two_sides_equals_the_remaining_side_three() {
    let sides = [4, 2, 2];
    let triangle = Triangle::build(sides).unwrap();
    assert!(triangle.is_degenerate());
}
